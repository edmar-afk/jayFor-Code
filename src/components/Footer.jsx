			...
			<footer className="bg-gray-800">
				<div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
					<p
						...
						role="alert">
						<span className="text-xs bg-purple-400 hover:bg-purple-200 duration-200 rounded-full text-white font-bold px-4 py-1.5 mr-3">
							Updated
						</span>
								...
								return (
									<a
										...
										<FontAwesomeIcon
											...
											className="text-5xl"
										/>
										<span className="text-3xl font-bold ml-2 hidden md:block">{links.name}</span>
									</a>
								);
							})}
						</div>
