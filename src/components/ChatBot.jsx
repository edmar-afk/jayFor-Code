		...
		<>
			{viewChat && (
				<div
					...
					className={`fixed ${
						isHovered && "opacity-40 delay-1000"
					} duration-500 bottom-24 md:bottom-28 overflow-y-scroll animate-fade right-2 md:right-16 bg-gray-300 rounded-l-xl h-[500px] w-full max-w-[360px] md:max-w-[400px] z-50`}>
